                    ...
                    <table class="table table-hover">
                        ...
                        @foreach ($data as $key=>$value)
                            <tbody>
                                ...
                                <td>{{\App\Helper::sifat($value->sifat)}}</td>
                                <td>{{\App\Helper::bobot($value->bobot)}}</td>
                                <td>
                                    <a href="{{ url('kriteria/edit/'.$value->id_kriteria) }}" class="btn btn-xs btn-success"><i>Edit</i></a>
                                    <a href="{{ url('kriteria/hapus/'.$value->id_kriteria) }}" class="btn btn-xs btn-danger"><i>Hapus</i></a>
                                </td>
                            </tbody>
                        @endforeach
                      </table>
